...
// ai-studio-step-id: pw16cu8d40
await leapwork.step(`Fill the New team name field with "${teamName}"`, async () => {
    // Fill textbox
    await page.getByRole('textbox').nth(1).fill(String(teamName));
    
}, { action: "input"});

// ai-studio-step-id: pw1wid85v0
await leapwork.step("Press Enter to submit the form", async () => {
    // Press Enter on element
     await page.waitForTimeout(2000);
    await page.keyboard.press("Enter");
}, { action: "keydown", timeoutMs : 70000 });
